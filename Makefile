# This Makefile is for the Finance::Quote::Moex extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Finance/Quote/Moex.pm]
#     AUTHOR => [q[Partizand <partizand@gmail.com>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
...
MAKE = make
FULLEXT = Finance/Quote/Moex
BASEEXT = Moex
PARENT_NAME = Finance::Quote
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Finance/Quote/Moex.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIBDEP)$(DFSEP)Config.pm $(PERL_INCDEP)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Finance/Quote
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Finance/Quote
...
TO_INST_PM = lib/Finance/Quote/Moex.pm
...
manifypods : pure_all config  \
	lib/Finance/Quote/Moex.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) -u \
	  lib/Finance/Quote/Moex.pm $(INST_MAN3DIR)/Finance::Quote::Moex.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Perl module. Obtain quotes from Moex exchange. '\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Partizand <partizand@gmail.com>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Finance-Quote-Moex' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "Perl module. Obtain quotes from Moex exchange. ",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Partizand <partizand@gmail.com>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Finance-Quote-Moex",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    </IMPLEMENTATION>' >> Finance-Quote-Moex.ppd
	$(NOECHO) $(ECHO) '</SOFTPKG>' >> Finance-Quote-Moex.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  'lib/Finance/Quote/Moex.pm' 'blib/lib/Finance/Quote/Moex.pm' 
